...
access_logger = logging.getLogger("service.access")
...
def log_access(api_path: str, method: str, status_code: int, response_time_ms: int, **fields: Any) -> None:
    extra = {
        "log_type": "ACCESS_LOG",
        "api_path": api_path,
        "http_method": method,
    ...
    access_logger.info(f"{method} {api_path} {status_code} {response_time_ms}ms", extra=extra)
